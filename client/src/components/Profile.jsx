...
export const Profile = ({ loggedInUser }) => {
    ...
    return (profile.id &&
        <div className="max-w-3xl mx-auto px-6 py-10">
            <div className="h-[80vh] bg-white rounded-2xl shadow-md border border-gray-100 p-6 flex flex-col sm:flex-row items-center sm:items-start gap-6">
                ...
                <div className="flex-1">
                    ...
                    {loggedInUser.id === profile.id && (
                        <div className="space-y-1 mb-6">
                            ...
                            <p className="text-sm text-gray-700">🏠 <span className="font-medium">Address:</span> {profile.address}</p>
